...
- [x] Reuse existing RDF parser and serializer helpers from `docs/app/rdf-io.js`.
- [x] Load existing local RDF vendor assets from `docs/app/vendor/`.
...
- Reused through `docs/app/rdf-io.js`.
